...
function StoryInfo() {
	return (
		<div className="story storyInfo">
			<span className="story_number">번호</span>
			<span className="story_title">게시글 제목</span>
			<span className="story_name">작성자</span>
			<span className="story_time">작성일</span>
		</div>
	);
}
