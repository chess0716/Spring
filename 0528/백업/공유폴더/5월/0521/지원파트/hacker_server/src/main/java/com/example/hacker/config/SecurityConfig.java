package com.example.hacker.config;

import com.example.hacker.security.filter.ApiCheckFilter;
...
public class SecurityConfig {
  ...
  private static final String[] PERMIT_ALL_LIST = {
      "/auth/join", "/auth/login", "/members/me", "/auth/logout", "/members/get/**"
      , "/mypage/**", "/user/**", "/members/delete/**", "/members/update"
  };
