...
//	}
	...
	public String list(Model model, String pageNum,
		...
		/////
		int currentPage = pageNum==null ? 1 : Integer.parseInt(pageNum); //�쁽�옱�럹�씠吏�
		int pageSize = 5;
		
		HashMap<String, Object> hm = new HashMap<String, Object>();
		hm.put("field", field);
		hm.put("word", word);
		hm.put("pageStart", (currentPage-1)*pageSize);  //1�럹�씠吏�->1, 2�럹�씠吏�->6, 3�럹�씠吏�->11
		hm.put("pageSize", pageSize);
	//	System.out.println(hm);
		
		int count = boardService.getCount(hm); //珥앷쾶�떆臾� �닔 
	...
	@GetMapping("delete/{num}")   // �궘�젣111
	public String delete1(@PathVariable  int num) {
		boardService.delete(num);
		return "redirect:/list";
	}
	
	@GetMapping("delete")   // �궘�젣222
